<template>
  <div class="layout">
    <HeaderMain class="layout__header"/>
    <aside class="layout__aside markdown-body">
      <p>I'm a software engineer at <a href="#">The Changing Workplace</a> in Haywards Heath, UK.</p>
    ...
    <div class="layout__content markdown-body">
      <Content />
    </div>
  </div>
</template>
